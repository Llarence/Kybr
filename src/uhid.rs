...
pub type hid_class_request = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_create2_req"][::std::mem::size_of::<uhid_create2_req>() - 4372usize];
    ["Alignment of uhid_create2_req"][::std::mem::align_of::<uhid_create2_req>() - 1usize];
    ["Offset of field: uhid_create2_req::name"]
        [::std::mem::offset_of!(uhid_create2_req, name) - 0usize];
    ["Offset of field: uhid_create2_req::phys"]
        [::std::mem::offset_of!(uhid_create2_req, phys) - 128usize];
    ["Offset of field: uhid_create2_req::uniq"]
        [::std::mem::offset_of!(uhid_create2_req, uniq) - 192usize];
    ["Offset of field: uhid_create2_req::rd_size"]
        [::std::mem::offset_of!(uhid_create2_req, rd_size) - 256usize];
    ["Offset of field: uhid_create2_req::bus"]
        [::std::mem::offset_of!(uhid_create2_req, bus) - 258usize];
    ["Offset of field: uhid_create2_req::vendor"]
        [::std::mem::offset_of!(uhid_create2_req, vendor) - 260usize];
    ["Offset of field: uhid_create2_req::product"]
        [::std::mem::offset_of!(uhid_create2_req, product) - 264usize];
    ["Offset of field: uhid_create2_req::version"]
        [::std::mem::offset_of!(uhid_create2_req, version) - 268usize];
    ["Offset of field: uhid_create2_req::country"]
        [::std::mem::offset_of!(uhid_create2_req, country) - 272usize];
    ["Offset of field: uhid_create2_req::rd_data"]
        [::std::mem::offset_of!(uhid_create2_req, rd_data) - 276usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_start_req"][::std::mem::size_of::<uhid_start_req>() - 8usize];
    ["Alignment of uhid_start_req"][::std::mem::align_of::<uhid_start_req>() - 8usize];
    ["Offset of field: uhid_start_req::dev_flags"]
        [::std::mem::offset_of!(uhid_start_req, dev_flags) - 0usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_input2_req"][::std::mem::size_of::<uhid_input2_req>() - 4098usize];
    ["Alignment of uhid_input2_req"][::std::mem::align_of::<uhid_input2_req>() - 1usize];
    ["Offset of field: uhid_input2_req::size"]
        [::std::mem::offset_of!(uhid_input2_req, size) - 0usize];
    ["Offset of field: uhid_input2_req::data"]
        [::std::mem::offset_of!(uhid_input2_req, data) - 2usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_output_req"][::std::mem::size_of::<uhid_output_req>() - 4099usize];
    ["Alignment of uhid_output_req"][::std::mem::align_of::<uhid_output_req>() - 1usize];
    ["Offset of field: uhid_output_req::data"]
        [::std::mem::offset_of!(uhid_output_req, data) - 0usize];
    ["Offset of field: uhid_output_req::size"]
        [::std::mem::offset_of!(uhid_output_req, size) - 4096usize];
    ["Offset of field: uhid_output_req::rtype"]
        [::std::mem::offset_of!(uhid_output_req, rtype) - 4098usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_get_report_req"][::std::mem::size_of::<uhid_get_report_req>() - 6usize];
    ["Alignment of uhid_get_report_req"][::std::mem::align_of::<uhid_get_report_req>() - 1usize];
    ["Offset of field: uhid_get_report_req::id"]
        [::std::mem::offset_of!(uhid_get_report_req, id) - 0usize];
    ["Offset of field: uhid_get_report_req::rnum"]
        [::std::mem::offset_of!(uhid_get_report_req, rnum) - 4usize];
    ["Offset of field: uhid_get_report_req::rtype"]
        [::std::mem::offset_of!(uhid_get_report_req, rtype) - 5usize];
};
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_get_report_reply_req"]
        [::std::mem::size_of::<uhid_get_report_reply_req>() - 4104usize];
    ["Alignment of uhid_get_report_reply_req"]
        [::std::mem::align_of::<uhid_get_report_reply_req>() - 1usize];
    ["Offset of field: uhid_get_report_reply_req::id"]
        [::std::mem::offset_of!(uhid_get_report_reply_req, id) - 0usize];
    ["Offset of field: uhid_get_report_reply_req::err"]
        [::std::mem::offset_of!(uhid_get_report_reply_req, err) - 4usize];
    ["Offset of field: uhid_get_report_reply_req::size"]
        [::std::mem::offset_of!(uhid_get_report_reply_req, size) - 6usize];
    ["Offset of field: uhid_get_report_reply_req::data"]
        [::std::mem::offset_of!(uhid_get_report_reply_req, data) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_set_report_req"][::std::mem::size_of::<uhid_set_report_req>() - 4104usize];
    ["Alignment of uhid_set_report_req"][::std::mem::align_of::<uhid_set_report_req>() - 1usize];
    ["Offset of field: uhid_set_report_req::id"]
        [::std::mem::offset_of!(uhid_set_report_req, id) - 0usize];
    ["Offset of field: uhid_set_report_req::rnum"]
        [::std::mem::offset_of!(uhid_set_report_req, rnum) - 4usize];
    ["Offset of field: uhid_set_report_req::rtype"]
        [::std::mem::offset_of!(uhid_set_report_req, rtype) - 5usize];
    ["Offset of field: uhid_set_report_req::size"]
        [::std::mem::offset_of!(uhid_set_report_req, size) - 6usize];
    ["Offset of field: uhid_set_report_req::data"]
        [::std::mem::offset_of!(uhid_set_report_req, data) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_set_report_reply_req"]
        [::std::mem::size_of::<uhid_set_report_reply_req>() - 6usize];
    ["Alignment of uhid_set_report_reply_req"]
        [::std::mem::align_of::<uhid_set_report_reply_req>() - 1usize];
    ["Offset of field: uhid_set_report_reply_req::id"]
        [::std::mem::offset_of!(uhid_set_report_reply_req, id) - 0usize];
    ["Offset of field: uhid_set_report_reply_req::err"]
        [::std::mem::offset_of!(uhid_set_report_reply_req, err) - 4usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_create_req"][::std::mem::size_of::<uhid_create_req>() - 284usize];
    ["Alignment of uhid_create_req"][::std::mem::align_of::<uhid_create_req>() - 1usize];
    ["Offset of field: uhid_create_req::name"]
        [::std::mem::offset_of!(uhid_create_req, name) - 0usize];
    ["Offset of field: uhid_create_req::phys"]
        [::std::mem::offset_of!(uhid_create_req, phys) - 128usize];
    ["Offset of field: uhid_create_req::uniq"]
        [::std::mem::offset_of!(uhid_create_req, uniq) - 192usize];
    ["Offset of field: uhid_create_req::rd_data"]
        [::std::mem::offset_of!(uhid_create_req, rd_data) - 256usize];
    ["Offset of field: uhid_create_req::rd_size"]
        [::std::mem::offset_of!(uhid_create_req, rd_size) - 264usize];
    ["Offset of field: uhid_create_req::bus"]
        [::std::mem::offset_of!(uhid_create_req, bus) - 266usize];
    ["Offset of field: uhid_create_req::vendor"]
        [::std::mem::offset_of!(uhid_create_req, vendor) - 268usize];
    ["Offset of field: uhid_create_req::product"]
        [::std::mem::offset_of!(uhid_create_req, product) - 272usize];
    ["Offset of field: uhid_create_req::version"]
        [::std::mem::offset_of!(uhid_create_req, version) - 276usize];
    ["Offset of field: uhid_create_req::country"]
        [::std::mem::offset_of!(uhid_create_req, country) - 280usize];
};
impl Default for uhid_create_req {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_input_req"][::std::mem::size_of::<uhid_input_req>() - 4098usize];
    ["Alignment of uhid_input_req"][::std::mem::align_of::<uhid_input_req>() - 1usize];
    ["Offset of field: uhid_input_req::data"]
        [::std::mem::offset_of!(uhid_input_req, data) - 0usize];
    ["Offset of field: uhid_input_req::size"]
        [::std::mem::offset_of!(uhid_input_req, size) - 4096usize];
};
impl Default for uhid_input_req {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_output_ev_req"][::std::mem::size_of::<uhid_output_ev_req>() - 8usize];
    ["Alignment of uhid_output_ev_req"][::std::mem::align_of::<uhid_output_ev_req>() - 1usize];
    ["Offset of field: uhid_output_ev_req::type_"]
        [::std::mem::offset_of!(uhid_output_ev_req, type_) - 0usize];
    ["Offset of field: uhid_output_ev_req::code"]
        [::std::mem::offset_of!(uhid_output_ev_req, code) - 2usize];
    ["Offset of field: uhid_output_ev_req::value"]
        [::std::mem::offset_of!(uhid_output_ev_req, value) - 4usize];
};
#[repr(C, packed)]
#[derive(Debug, Default, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_feature_req"][::std::mem::size_of::<uhid_feature_req>() - 6usize];
    ["Alignment of uhid_feature_req"][::std::mem::align_of::<uhid_feature_req>() - 1usize];
    ["Offset of field: uhid_feature_req::id"]
        [::std::mem::offset_of!(uhid_feature_req, id) - 0usize];
    ["Offset of field: uhid_feature_req::rnum"]
        [::std::mem::offset_of!(uhid_feature_req, rnum) - 4usize];
    ["Offset of field: uhid_feature_req::rtype"]
        [::std::mem::offset_of!(uhid_feature_req, rtype) - 5usize];
};
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_feature_answer_req"]
        [::std::mem::size_of::<uhid_feature_answer_req>() - 4104usize];
    ["Alignment of uhid_feature_answer_req"]
        [::std::mem::align_of::<uhid_feature_answer_req>() - 1usize];
    ["Offset of field: uhid_feature_answer_req::id"]
        [::std::mem::offset_of!(uhid_feature_answer_req, id) - 0usize];
    ["Offset of field: uhid_feature_answer_req::err"]
        [::std::mem::offset_of!(uhid_feature_answer_req, err) - 4usize];
    ["Offset of field: uhid_feature_answer_req::size"]
        [::std::mem::offset_of!(uhid_feature_answer_req, size) - 6usize];
    ["Offset of field: uhid_feature_answer_req::data"]
        [::std::mem::offset_of!(uhid_feature_answer_req, data) - 8usize];
};
impl Default for uhid_feature_answer_req {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_event__bindgen_ty_1"]
        [::std::mem::size_of::<uhid_event__bindgen_ty_1>() - 4376usize];
    ["Alignment of uhid_event__bindgen_ty_1"]
        [::std::mem::align_of::<uhid_event__bindgen_ty_1>() - 8usize];
    ["Offset of field: uhid_event__bindgen_ty_1::create"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, create) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::input"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, input) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::output"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, output) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::output_ev"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, output_ev) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::feature"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, feature) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::get_report"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, get_report) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::feature_answer"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, feature_answer) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::get_report_reply"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, get_report_reply) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::create2"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, create2) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::input2"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, input2) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::set_report"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, set_report) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::set_report_reply"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, set_report_reply) - 0usize];
    ["Offset of field: uhid_event__bindgen_ty_1::start"]
        [::std::mem::offset_of!(uhid_event__bindgen_ty_1, start) - 0usize];
};
impl Default for uhid_event__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of uhid_event"][::std::mem::size_of::<uhid_event>() - 4380usize];
    ["Alignment of uhid_event"][::std::mem::align_of::<uhid_event>() - 1usize];
    ["Offset of field: uhid_event::type_"][::std::mem::offset_of!(uhid_event, type_) - 0usize];
    ["Offset of field: uhid_event::u"][::std::mem::offset_of!(uhid_event, u) - 4usize];
};
